...
import RemoveFromWatchlist from "../components/cardIcons/removeFromWatchlist"; // The new action component for removing from watchlist
...
const WatchlistPage: React.FC = () => {
  ...
  const displayedMovies = allWatchlistMovies
    ? filterFunction(allWatchlistMovies)
    : [];
